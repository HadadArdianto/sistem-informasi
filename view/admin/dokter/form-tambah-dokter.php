<?php
generate_kode('dokter', 'kode_dokter', 'DKR', $kode);
if (isset($_POST['tambah-dokter'])) {
    ...
    if (!empty($errors)) {
        ...
        insert_dokter($kode, $nama, $sip, $tempatlahir, $tgllahir, $alamat, $tlp, $kategori, $failed);
    }
}
?>
                            ...
                            <div class="card-body">
                                <form class="form" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="last-name-column">SIP</label>
                                                <input type="text" id="last-name-column" class="form-control"
                                                    placeholder="SIP dokter" name="sip">
                                                <?php
                                                if (isset($error)) {
                                                    ?>
                                                    <small class="text-danger">
                                                    ...
                                                    <optgroup label="kategori">
                                                        ...
                                                        if (mysqli_num_rows($result) < 1) {
                                                            ...
                                                            while ($data = mysqli_fetch_assoc($result)) {
                                                                ?>
                                                                <option value="<?= $data['id_kategori_dokter'] ?>">
                                                                    <?= $data['kategori_dokter'] ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <div class="col-12 d-flex justify-content-end mt-2 ">
                                            <button type="submit" name="tambah-dokter"
